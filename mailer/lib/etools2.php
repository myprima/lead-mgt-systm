...
$database_name='readygol_mailer_5';
$database_user='ready_mailer_2';
$database_password='fTN$k907Vp';
...
/*
if(!$install && !defined("CLI_MODE") && getenv("OS")!='Windows_NT') {
...
//    if ($right_descr = "Edit contacts" || $right_descr = "Delete contacts")
//    {
//	    $q=sqlquery("
//		select grants.object_id from rights,grants
//		where rights.right_id=grants.right_id 
//		    and rights.name='Interest Group' and
//		    grants.user_id='$user_id' $q");
