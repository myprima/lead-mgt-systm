...
if(!$HTTPS) {
    $spaw_dir='http://lmsweb.in:/mailer/spaw/';	// directory where spaw files are located
    $spaw_base_url='http://lmsweb.in:/mailer/';	// base url for images
}
else {
    $spaw_dir='https:///spaw/';
    $spaw_base_url='https:///';
...
$spaw_root='D:\\Inetpub\\vhosts\\readygolds.in\\root\\mailer\\/spaw/';
...
$spaw_imglibs = array(
  array(
    'value'=>'/var/www/vhosts/ilobachev.sa.plesk.ru/httpdocs/mailer63/img/',
    'text'    => 'Images'
  )
);
