<html>
  ...
  <body>
        ...
        <!-- Logo -->
        <a href="index2.html" class="logo"><b>Client</b>LMS</a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="<?php echo base_url('assets/dist/img/user2-160x160.jpg');?>" class="img-circle" alt="User Image" />
                    <p>
                      Welcome <?php echo $this->session->userdata('Name'); ?> - Client
                      <small></small>
                    </p>
                  </li>
                  <!-- Menu Body -->
  ...
  <div class="col-xs-4 text-center">
    <a href="#">Friends</a>
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo site_url('pages/profile');?>" class="btn btn-default btn-flat">Profile</a>
                    </div>
