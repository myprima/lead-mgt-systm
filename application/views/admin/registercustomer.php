            ...
            <form role="form">
              <div class="box-body">
                <div class="row">
                 <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Serial No">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Dealers Type">
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <div class="hero-unit">
                        <input type="text" class="form-control pull-right" id="example1">
                      </div>
                    </div><!-- /.input group -->
                  </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text"  maxlength="11" class="form-control" id="exampleInputEmail1" placeholder="Enter Contact">
                </div>
                <div class="form-group">
