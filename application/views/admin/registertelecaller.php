        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Tele Caller Registration form</h3>
            </div><!-- /.box-header -->
            <!-- form start -->

            <?php echo form_open('admin/TelecallerController/insert'); ?>
            <div class="box-body">
              <div class="row">
                <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <textarea name="txtAddress" id="" cols="30" rows="5" class="form-control"><?php echo set_value('txtAddress') ?></textarea>
              ...
              <label for="exampleInputEmail1">User Id:</label>
                <input type="text" value="<?php echo set_value('txtUserId') ?>" name="txtUserId" class="form-control" id="exampleInputEmail1" placeholder="Enter User Id">
